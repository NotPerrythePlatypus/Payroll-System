...
<div class="header" id="printPageButton">
    ...
    <button onclick="document.getElementById('id01').style.display='block'" style="color: white; margin: 5px; font-size: 20px; float: right" class="btn">Check PF Status</button>
    <h3  style="color: white;   margin-right: 8px; text-decoration: bold;"><center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Provident Fund Status</center></h3>
</div>
  ...
  <form class="modal-content animate" action="PFstatus.php" method="post">
  ...
  box-sizing: border-box;" type="text" placeholder="Enter Your Employee Code" name="roll" class="roll" required>
...
$roll = $_POST['roll'];      
$sql = "SELECT * FROM `pf` WHERE `EMP`= '$roll' ";
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-center lh-1 mb-2">
                            <h4 class="fw-bold">Povident Fund Status</h4> <span class="fw-normal">PF slip for the month of March 2022</span>
                        </div>
                        <div class="row">
                            <div class="col-md-10">
                                <div class="row">
                            ...
                            <table class="mt-4 table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row">Existing Amount</th>
                                        <td>₹ <?php echo $row['EA']; ?></td>
                                        
                                    </tr>
                                    <tr>
                                        <th scope="row">March Credit</th>
                                    ...
                                    <tr class="border-top">
                                        ...
                                        <th>₹ <?php echo $row['TA']; ?></th>
                                        
                                    </tr>
                                    <tr class="border-top">
                                        <th scope="row">In words</th>
                                        <th> <?php echo $get_amount ?></th>
